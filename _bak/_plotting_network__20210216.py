...
def plot_out_degree_distribution(out_degree_distribution,num_bins):
    ...
    fig, ax = plt.subplots(nrows = 1, ncols = 2, sharex = False, sharey = False, figsize=(15,11))
...
def plot_distance_matrix(distance_mat,num_nodes):
    ...
    error = ax.imshow(np.transpose(distance_mat[:,:]), cmap = plt.cm.viridis, interpolation='none', extent=[0,num_nodes-1,0,num_nodes-1], aspect = 'auto', origin = 'lower', figsize=(10,10))
