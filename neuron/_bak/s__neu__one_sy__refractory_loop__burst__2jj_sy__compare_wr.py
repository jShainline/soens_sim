...
for ii in range(num_L_si):
    ...
    for jj in range(num_tau_si):
        ...
        for kk in range(num_I_sy):
            ...
            file_name = 'neu_{:d}jj_Isy{:02.0f}uA_Lsi{:07.2f}nH_Lmsi{:03.0f}pH_tausi{:04.0f}ns_Inf{:02.0f}uA_Lnf{:05.2f}pH_Lmnf{:02.0f}pH_taunf{:02.0f}ns_Irf{:02.0f}uA_Lri{:05.2f}pH_Lmri{:02.0f}pH_tauri{:02.0f}ns.dat'.format(num_jjs__syn,I_sy*1e6,L_si*1e9,L_msi*1e12,tau_si*1e9,I_nf*1e6,L_nf*1e12,L_mnf*1e12,tau_nf*1e9,I_rf*1e6,L_ri*1e12,L_mri*1e12,tau_ri*1e9)
